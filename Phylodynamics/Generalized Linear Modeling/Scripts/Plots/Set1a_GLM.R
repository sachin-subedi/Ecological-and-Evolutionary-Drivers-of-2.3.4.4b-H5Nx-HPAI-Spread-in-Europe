...
read_glm_set1a <- function(sub_name, glm_dir) {
  fp <- file.path(glm_dir, "Set1a", sprintf("%s_Set1a_GLMSummary.txt", sub_name))
...
ggsave(
  filename = "Set1a_GeoCluster_GLM_cluster_summary_plot_allSubsamples.png",
  plot     = combined_plot,
  width    = 14,
  height   = 10,
  dpi      = 300,
...
write_csv(glm_summary,
          "Set1a_GeoCluster_GLM_glm_summary_sortedBF.csv")
