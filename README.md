...
<small> Highly pathogenic avian influenza (HPAI) H5Nx clade 2.3.4.4b has been circulating in Europe since 2016, threatening poultry, wildlife, and public health, yet the determinants of viral spillover, spread, and annual emergence remain poorly understood. Here, we show, by integrating genomic, ecological, and epidemiological data from 2016 to 2025 in a comparative phylogeographic framework, that European transmission is organized around persistent regional and habitat reservoirs. We analyzed 7,031 European H5Nx hemagglutinin sequences with habitat traits, defining ten regional strata by cross-classifying hierarchical geographic clusters with European biogeographic regions, and assessed three subsampling strategies across nine datasets. The Atlantic region served as a persistent reservoir for the long-term circulation, and the Western Continental region as a secondary hub structuring cross-regional transmission. Wetlands formed the backbone of transmission, repeatedly seeding farms, grasslands, and coastal areas. Anatidae migration was the most robust predictor of inter-regional transmission, with live-poultry trade contributing to a secondary, sampling-dependent signal, identifying migratory connectivity and trade corridors as surveillance priorities. </small>
